...
namespace HRWebApp.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Employee_ID,First_Name,Last_Name,Middle_Initial,Address1,Address2,City,State,Zip,Email,Phone_Number,Social_Security_Number,Drivers_License,Marital_Status,Gender,Shareholder_Status,Benefit_Plans,Ethnicity")] Personal personal)
        {
      ...
      "1820407",
      "658f3c8a3e5ef69474b1",
      "91cbb9edf633279a8184",
      options);

                var result = await pusher.TriggerAsync(
                    "IntegrationSystem",
                    "HR-person-created",
                    new { message = "A new personal has been created", personal = personal });
